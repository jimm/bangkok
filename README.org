...
The Web site of Bangkok is (http://github.com/jimm/bangkok). The older
RubyForge project page is http://rubyforge.org/projects/bangkok. Bangkok is
also available as a RubyGem.
